...
const NewArrivals = () => {
    ...
    const scroll = (direction) => {
        //if direction is left move left 300px else move right 300px
    ...
    return (
        <section className="py-16 px-4 lg:px-0">
            ...
            <div
                ref={scrollRef}
                className={`container mx-auto overflow-x-scroll flex space-x-6 relative scrollbar-dynamic ${isDragging ? "cursor-grabbing" : "cursor-grab"}`}
